    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div v-if="Array.isArray(tempProduct.imagesUrl)">
                <div class="mb-2" v-for="(img, index) in tempProduct.imagesUrl"
                :key="index">
                  <div class="mb-3">
                    <label for="imageUrl" class="form-label">輸入圖片網址</label>
                  ...
                  <img class="img-fluid" :src="img" alt="產品圖片">
                </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="updata">
            確認
          </button>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      isNew: (state) => state.backstageModule.isNew,
    }),
  },
  mixins: [ModalMixin],
  methods: {
    updata() {
      ...
      if (this.isNew === true) {
        ...
        this.$http.put(`${process.env.VUE_APP_API}/v2/api/${process.env.VUE_APP_API_PATH}/admin/product/${this.tempProduct.id}`, obj)
          .then((res) => {
            alert(res.data.message);
            this.modal.hide();
            this.$emit('get-products');
